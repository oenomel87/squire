...
이 저장소에는 Codex용 스킬 [skills/squire-pr-review](./skills/squire-pr-review)가 포함되어 있습니다.
...
이 프로젝트 디렉터리에서 Claude Code를 실행하면 `.claude/commands/squire-pr-review.md`가 자동으로 슬래시 커맨드로 등록됩니다. 별도 설치가 필요 없습니다.
