...
squire create --repo <owner/repo> --title "..." --head <branch> --base <branch>
...
PR 동기화/조회만 사용할 경우 **읽기 전용 토큰**으로 동작 가능하다.
...
### 쓰기 기능: PR 생성 / GitHub 코멘트 게시

`squire create` 또는 Web UI에서 "GitHub에 게시" 기능을 사용할 경우 `Pull Requests: Write` 권한이 필요하다.
